...
void init()
{
    shader = std::make_shared<Shader>(
            ROOT_PATH PATH_SEP "src" PATH_SEP "13_stencil_test" PATH_SEP "material.vert",
            ROOT_PATH PATH_SEP "src" PATH_SEP "13_stencil_test" PATH_SEP "material.frag"
    );

    frameShader = std::make_shared<Shader>(
            ROOT_PATH PATH_SEP "src" PATH_SEP "13_stencil_test" PATH_SEP "material.vert",
            ROOT_PATH PATH_SEP "src" PATH_SEP "13_stencil_test" PATH_SEP "singleColor.frag"
    );

    terrainShader = std::make_shared<Shader>(
            ROOT_PATH PATH_SEP "src" PATH_SEP "13_stencil_test" PATH_SEP "material.vert",
            ROOT_PATH PATH_SEP "src" PATH_SEP "13_stencil_test" PATH_SEP "terrain.frag"
    );
