...
void init()
{
    shader = std::make_shared<Shader>(
            ROOT_PATH PATH_SEP "src" PATH_SEP "14_face_culling" PATH_SEP "material.vert",
            ROOT_PATH PATH_SEP "src" PATH_SEP "14_face_culling" PATH_SEP "material.frag"
    );

    lightShader = std::make_shared<Shader>(
            ROOT_PATH PATH_SEP "src" PATH_SEP "14_face_culling" PATH_SEP "light_source.vert",
            ROOT_PATH PATH_SEP "src" PATH_SEP "14_face_culling" PATH_SEP "light_source.frag"
    );
