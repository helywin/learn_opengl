...
void init()
{
    shader = std::make_shared<Shader>(
            ROOT_PATH PATH_SEP "src" PATH_SEP "8_material" PATH_SEP "material.vert",
            ROOT_PATH PATH_SEP "src" PATH_SEP "8_material" PATH_SEP "material.frag"
    );

    lightShader = std::make_shared<Shader>(
            ROOT_PATH PATH_SEP "src" PATH_SEP "8_material" PATH_SEP "light_source.vert",
            ROOT_PATH PATH_SEP "src" PATH_SEP "8_material" PATH_SEP "light_source.frag"
    );
...
void draw()
{
    ...
    shader->setVec3("material.diffuse", objectColor.x, objectColor.y, objectColor.z);
