...
void init()
{
    gModel = std::make_shared<Model>(RES_DIR PATH_SEP "standard_cube.obj");

    shader = std::make_shared<Shader>(
            ROOT_PATH PATH_SEP "src" PATH_SEP "15_frame_buffer" PATH_SEP "material.vert",
            ROOT_PATH PATH_SEP "src" PATH_SEP "15_frame_buffer" PATH_SEP "material.frag"
    );

    screenShader = std::make_shared<Shader>(
            ROOT_PATH PATH_SEP "src" PATH_SEP "15_frame_buffer" PATH_SEP "screen.vert",
            ROOT_PATH PATH_SEP "src" PATH_SEP "15_frame_buffer" PATH_SEP "screen.frag"
    );
...
void draw()
{
    ...
    glBindTexture(GL_TEXTURE_2D, 0);	// use the color attachment texture as the texture of the quad plane
